  ...
  render() {
    return (
      <div>
        {this.state.questao1 ? 
          <Card>
            <CardHeader>Qual o nome técnico da placa A-37? <img src={a37}  width="120px" height="120px"/></CardHeader>
            <CardBody>
            <Question1 alternativa={this._selectQuestion}/> 
            </CardBody>
        ...
        {this.state.questao2 ?
          <Card>
            <CardHeader>Qual o nome técnico da placa R-24a? <img src={r24a} width="120px" height="120px" /></CardHeader>
            <CardBody>
              <Question2 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao3 ?
          <Card>
            ...
            <CardBody>
              <Question3 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao4 ?
          <Card>
            ...
            <CardBody>
              <Question4 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao5 ?
          <Card>
            ...
            <CardBody>
              <Question5 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao6 ?
          <Card>
            ...
            <CardBody>
              <Question6 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao7 ?
          <Card>
            ...
            <CardBody>
              <Question7 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao8 ?
          <Card>
            ...
            <CardBody>
              <Question8 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao9 ?
          <Card>
            ...
            <CardBody>
              <Question9 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao10 ?
          <Card>
            ...
            <CardBody>
              <Question10 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao11 ?
          <Card>
            ...
            <CardBody>
              <Question11 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao12 ?
          <Card>
            ...
            <CardBody>
              <Question12 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao13 ?
          <Card>
            ...
            <CardBody>
              <Question13 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao14 ?
          <Card>
            ...
            <CardBody>
              <Question14 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao15 ?
          <Card>
            ...
            <CardBody>
              <Question15 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao16 ?
          <Card>
            ...
            <CardBody>
              <Question16 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao17 ?
          <Card>
            ...
            <CardBody>
              <Question17 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao18 ?
          <Card>
            ...
            <CardBody>
              <Question18 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao19 ?
          <Card>
            ...
            <CardBody>
              <Question19 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao20 ?
          <Card>
            <CardHeader>Qual o nome técnico da placa s-3: <img src={s3} width="120px" height="120px" /></CardHeader>
            <CardBody>
              <Question20 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao21 ?
          <Card>
            ...
            <CardBody>
              <Question21 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao22 ?
          <Card>
            ...
            <CardBody>
              <Question22 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao23 ?
          <Card>
            ...
            <CardBody>
              <Question23 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao24 ?
          <Card>
            ...
            <CardBody>
              <Question24 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao25 ?
          <Card>
            ...
            <CardBody>
              <Question25 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao26 ?
          <Card>
            ...
            <CardBody>
              <Question26 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao27 ?
          <Card>
            ...
            <CardBody>
              <Question27 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao28 ?
          <Card>
            ...
            <CardBody>
              <Question28 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao29 ?
          <Card>
            ...
            <CardBody>
              <Question29 alternativa={this._selectQuestion}/>
            </CardBody>
        ...
        {this.state.questao30 ?
          <Card>
            ...
            <CardBody>
              <Question30 alternativa={this._selectQuestion}/>
            </CardBody>
            <CardFooter><Button onClick={() => { this._endQuestions() }}>Proxíma</Button></CardFooter>
          </Card>
        : null}
